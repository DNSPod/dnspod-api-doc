...
请求参数：
    ...
    参数名              是否必须            参数描述                               
    ================    =================   =====================================================
    公共参数            是                  详见：`公共参数 <info.html#common-parameters>`_
...
请求参数：
    ...
    group_id            否                  分组ID, 获取指定分组的域名。可以通过 `获取域名分组 <domains.html#domaingroup-list>`_ 获取 group_id
...
请求参数：
    ...
    公共参数                是                  详见：`公共参数 <info.html#common-parameters>`_
    domain_id 或 domain     是                  分别对应域名ID和域名, 提交其中一个即可
    days                    是                  域名要锁定的天数，最多可锁定的天数可以通过 `获取域名权限 <domains.html#domain-purview>`_ 接口获取
    =====================   =================   =====================================================
...
请求参数：
    ...
    公共参数                是                  详见：`公共参数 <info.html#common-parameters>`_
    domain                  是                  要取回的域名
    email                   是                  域名取回WHOIS邮箱列表中的一个邮箱，验证码会发送到该邮箱
    =====================   =================   =====================================================
...
请求参数：
    ...
    公共参数                是                  详见：`公共参数 <info.html#common-parameters>`_
    domain                  是                  要取回的域名
    whois_email             是                  域名取回WHOIS邮箱列表中的一个邮箱，验证链接会发送到该邮箱
    =====================   =================   =====================================================
